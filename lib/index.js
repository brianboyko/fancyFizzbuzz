...
var fizzbuzzer = function fizzbuzzer(number, options = {}) {
    var fizzer = options.fizzer || 3
    var buzzer = options.buzzer || 5
    var fizzOutput = options.fizzOutput || "Fizz"
    var buzzOutput = options.buzzOutput || "Buzz"
